...
class Skill:
    def __init__(self, ID, nome, descricao, tipos, numTurnos, dado, quantDados, eventos, pre_requisitos):
        self.ID = ID
        self.nome = nome
    ...
    def ligarSkill(self,alvo,valor):
        for tipo in self.tipos:
    ...
    def desligarSkill(self,alvo,valor):
        for tipo in self.tipos:
